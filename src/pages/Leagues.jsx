...
export default function Leagues() {
  ...
  const [newLeagueType, setNewLeagueType] = useState("Season");
  ...
  const handleCreateLeague = async (e) => {
    ...
    try {
      ...
      await createLeague(newLeagueName.trim(), user.$id, displayName, newLeagueType);
            ...
            <form onSubmit={handleCreateLeague}>
              ...
              <div className="form-group">
                ...
                <div className="league-type-selector">
                  <button
                    type="button"
                    className={`type-btn ${newLeagueType === "Season" ? "active" : ""}`}
                    onClick={() => setNewLeagueType("Season")}
                  >
                    <span className="type-icon">📅</span>
                    <span className="type-label">Season</span>
                    <span className="type-desc">Weekly scoring all season</span>
                  </button>
                  <button
                    type="button"
                    className={`type-btn ${newLeagueType === "OneOff" ? "active" : ""}`}
                    onClick={() => setNewLeagueType("OneOff")}
                  >
                    <span className="type-icon">🎯</span>
                    <span className="type-label">One-Off</span>
                    <span className="type-desc">Single day competition</span>
                  </button>
                </div>
              </div>
